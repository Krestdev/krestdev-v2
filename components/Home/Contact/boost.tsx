...
const Boost = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-10 py-[96px] bg-gradient-to-t from-[#000000] via-[#061D37] to-[#013B7D] w-full '>
            ...
            <Button className='w-fit bg-white text-black'>{t("button")}</Button>
        </div>
    )
}
