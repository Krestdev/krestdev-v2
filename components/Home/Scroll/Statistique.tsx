...
const Statistique = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-10 py-[96px] max-w-[1280px] w-full'>
            <div className='flex flex-row items-center justify-center w-[735px]'>
                <h2 className='text-black text-center'>
                    {t("title1")} <span className='font-mono font-normal'>{` ${t("title2")}`}</span>
                </h2>
            </div>
            <span className='flex flex-row justify-between px-7 containerBloc py-0'>
                <img src="/images/statistiques.png" alt="Statistique" className='w-[408px] h-[229.5px] object-cover' />
                <div className='flex flex-col justify-start gap-5 max-w-[735px] w-full'>
