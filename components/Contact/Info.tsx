...
const Info = () => {
  ...
  return (
    <div className='flex flex-col gap-10 pt-5'>
      <img src="/images/contact.png" alt="Contact" className='h-[349px] w-[620px] rounded-[20px] object-cover ' />
      <div className='flex flex-col gap-4 p-7 rounded-[20px] bg-[#D9EBFF] '>
        <div className='flex flex-row gap-4 px-5 py-3 rounded-[12px] bg-white'>
